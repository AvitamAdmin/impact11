                        ...
                        <LinearGradient
                          ...
                          <Text
                            style={{
                              ...
                              fontWeight: '600',
                              textAlign: 'center',
                         fontSize: hp(1.7), paddingBottom: 6,
                            }}>
                              ...
                              <View
                                ...
                                <LinearGradient
                                  ...
                                  <View
                                    ...
                                    <Text style={{fontWeight: '700', color: '#515151',fontSize: hp(1.6),}}>
                                        Run
                                      </Text>
                                    </View>
                                    <View
                                ...
                                <LinearGradient
                                  ...
                                  <View
                                    ...
                                    <View style={{width: wp('45%')}}>
                                    <Text style={{fontWeight: '700', color: '#515151',fontSize: hp(1.5),}}>
                                        Six Bonus
                                      </Text>
                                    </View>
                                    <View
                                ...
                                <LinearGradient
                                  ...
                                  <View
                                    ...
                                    <View style={{width: '70%'}}>
                                      <Text style={{fontWeight: '700', color: '#000',fontSize: hp(1.7),}}>
                                        Strick Rate Points (Except Bowler) 
                                      </Text>
                                      <Text style={{ color: '#515151',fontSize: hp(1.3),fontWeight: '500',}}>
                                ...
                                <LinearGradient
                                  ...
                                  <View
                                    ...
                                    <View style={{width: wp('50%')}}>
                                      ...
                                      <Text style={{fontWeight: '500', color: '#515151',fontSize: hp(1.3),}}>
