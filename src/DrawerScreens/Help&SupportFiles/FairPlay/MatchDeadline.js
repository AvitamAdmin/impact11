          ...
          <View style={{flexDirection: 'column', gap: 40}}>
            <View style={{flexDirection: 'column', gap: 15}}>
              ...
              <Text style={{color: '#000'}}>
                Impact11 initiates deadline at the official match start for all
                featured sports. The teams cannot be updated/edited post the
                deadline of the respective match. This deadline is put in place
                to ensure continued level playing field for all our users.
              </Text>
            </View>
