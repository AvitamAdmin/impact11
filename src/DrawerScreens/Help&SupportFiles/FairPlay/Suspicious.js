            ...
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  Using an third-party application or suspected hacking pursuit
                  to manipulate the score or game on Impact11 may lead to the
                  immediate termination of your account, which will forbid you
                  to stop playing games or using any other services provided by
                  Impact11
                </Text>
              </View>
