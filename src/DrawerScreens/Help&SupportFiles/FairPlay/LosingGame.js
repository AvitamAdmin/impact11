        ...
        <View
          ...
          <View
            ...
            <View style={{flexDirection: 'row', gap: 5}}>
              <Text
                style={{fontWeight: 'bold', fontSize: hp(2.5), color: '#000'}}>
                FairPlay
              </Text>
            </View>
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  Any user who engages in, participates in, assists in or
                  displays behaviour of intentionally losing at any game or
                  match to withdraw winnings, will be interpreted as having
                  unfair methods of participation. The user will be subject to
                  immediate termination of Impact11 services.
                </Text>
              </View>
