  ...
  return (
    <SafeAreaView>
      <View style={{height: hp('100%'), width: wp('100%')}}>
        <View
          style={{height: hp('18%'), width: wp('100%'), position: 'relative'}}>
          <LinearGradient
            style={{
              flex: 1,
            }}
              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  <Text
                    ...
                    I don't know much about Cricket/football can I still play?
                  </Text>
                  <Text style={{color: '#000'}}>
                    Impact11 is the fantasy gaming platform for everyone
                    including those who don’t know much about cricket. So, yes,
                    you can play even if you don’t know much about
                    cricket/football. We have given “How to Play” section on
                    Impact11 which can assist you in playing the game.
                  </Text>
                </View>
