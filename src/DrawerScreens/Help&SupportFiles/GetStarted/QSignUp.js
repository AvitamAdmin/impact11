              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    After downloading Impact11 App, as you head to the landing
                    page there will be "Sign Up" link you can click on that and
                    register your account. Users have to submit their name,
                    mobile number and email address to register. If you have an
                    invite code you can use that to get the bonus.
                  </Text>
                  <Text style={{color: '#000'}}>
                    And that it! LETS START WINNING!!
                  </Text>
                </View>
