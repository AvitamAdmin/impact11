              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Android users can download the Impact11 app from the Google
                    PlayStore.
                  </Text>
                  <Text style={{color: '#000'}}>
                    iOS users can also search for ‘Impact11’ in the App Store to
                    download the app.
                  </Text>
                  <Text style={{color: '#000'}}>or</Text>
                  <Text style={{color: '#000'}}>
                    Head to our website www.impacteleven.in on mobile web or
                    desktop website and enter your mobile number to get the
                    Download link.
                  </Text>
                </View>
