              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  <Text
                    ...
                    Why didn't I receive OTP?
                  </Text>
                  <Text style={{color: '#000'}}>
                    In case you haven’t received OTP on email or mobile number
                    from MyTeam11 after registering:
                  </Text>
                  <Text style={{color: '#000'}}>
                    If you use mobile number, you might have mistyped mobile
                    number, please check your mobile number once and try again.
                  </Text>
                  <Text style={{color: '#000'}}>
                    If its email, The mail sent by Impact11 might have been
                    marked as “Spam” and could have been sent to the spam folder
                    of your mailbox. In such a case, please check the spam
                    folder of your mailbox and mark Impact11 as ‘Not Spam,’
                    additionally add Impact11 to your contacts to avoid any
                    future inconvenience.
                  </Text>
                  <Text style={{color: '#000'}}>
                    or the user might have mistyped their email address. In such
                    a case, please check your email once and try again
                  </Text>
                </View>
