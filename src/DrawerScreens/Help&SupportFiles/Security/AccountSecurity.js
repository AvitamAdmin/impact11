              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Immediately go to profile page and click Log out, this will
                    make sure you’ve successfully logged out from all your
                    devices.
                  </Text>
                  <Text style={{color: '#000'}}>
                    If you still think the account is being used by someone
                    else, please contact us and we’ll help you resolve the
                    issue.
                  </Text>
                  <Text style={{color: '#000'}}>
                    Note: Never share your OTP details will anyone.
                  </Text>
                </View>
