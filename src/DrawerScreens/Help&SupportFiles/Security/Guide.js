              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Sometimes, players may find it hard to recognize that their
                    online play is getting out of control. A common reaction is
                    to minimize, hide or deny such problems and the harm it
                    could be causing. Some people will lie to themselves about
                    how much money or time is being spent on online playing.
                  </Text>
                  <Text style={{color: '#000'}}>
                    Following are some of the best practices to help you play
                    responsibly:
                  </Text>
                  <View style={{flexDirection: 'column', width: wp('78%')}}>
                    ...
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Keep track of the time and monitor the amount of money
                        you spend.
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Use the Add Cash limit option to help control the amount
                        you spend.
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Balance the time you spend on playing online games with
