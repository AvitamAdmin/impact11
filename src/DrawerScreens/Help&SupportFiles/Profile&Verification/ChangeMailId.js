              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    ...
                    click on the pencil icon on the email field, enter the new
                    email, enter the new OTP you receive, and that's it!
                  </Text>
                  <Text style={{color: '#000'}}>
                    Your new email ID is verified, and we'll notify you about
                    the change via email.
                  </Text>
                  <Text style={{color: '#000'}}>
                    A few things to remember while changing the email:
                  </Text>
                  <View style={{flexDirection: 'column', width: wp('78%')}}>
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Your new email is not linked to any other Impact11
                        account
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        You can change your email thrice from the app
                      </Text>
                    </View>
                  </View>
                </View>
