              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    First, you'll need to unlink your bank account and place a
                    verification request for a new one.
                  </Text>
                  <Text style={{color: '#000'}}>
                    To unlink your Bank account Go to My Balance from Side
                    Navigation menu and go to My KYC details page and click on
                    the bank account , Scroll down and click on unlink.
                  </Text>
                  <Text style={{color: '#000'}}>
                    Now, link your new bank account from the same KYC tab. For
                    this:
                  </Text>
                  <View style={{flexDirection: 'column', width: wp('78%')}}>
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <Text style={{color: '#000'}}>
                        Tap Bank Account and type your bank account details
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Upload a bank proof, and that's it!
                      </Text>
                    </View>
                  </View>
                  <Text style={{color: '#000'}}>
                    Here are some important points to keep in mind while
                  ...
                  <View style={{flexDirection: 'column', width: wp('78%')}}>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Once verified, the same bank account can't be verified
                        on any other Impact11 account
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        You can verify a bank account in your name only where
                        the bank account name matches the name on the verified
                        PAN
                      </Text>
                    </View>
