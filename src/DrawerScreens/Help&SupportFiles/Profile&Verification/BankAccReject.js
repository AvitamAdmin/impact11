              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    To verify your Bank account, you’ll have to verify your PAN
                    first
                  </Text>
                  <View style={{flexDirection: 'column', width: wp('78%')}}>
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <Text style={{color: '#000'}}>
                        Name on the bank proof uploaded matches the name on the
                        PAN card
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Correct bank account number, IFSC code and name are
                        updated in the form on the app
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Bank proof uploaded is a valid proof like a cancelled
                        cheque, account statement, or passbook 
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Bank details like account number, IFSC code and name are
                        clearly visible on the bank proof that you upload
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Details on the form and on the bank proof copy match
                        each other
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Uploaded bank proof is not password protected 
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Entire bank account number is visible on the bank proof
                        uploaded
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        No payment wallets are submitted. Payment banks are
                        accepted.
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        IFSC code belongs to the list of acceptable IFSC codes
