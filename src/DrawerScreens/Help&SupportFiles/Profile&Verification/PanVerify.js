              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Yes! Users need to verify their PAN and bank details for the
                    following reasons.
                  </Text>
                  <View style={{flexDirection: 'column', width: '98%'}}>
                    <View style={{flexDirection: 'row'}}>
                      ...
                      <Text style={{color: '#000'}}>
                        Withdrawals involve transferring your winning amount to
                        your bank account
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        To issue TDS certificates on time whenever applicable
                      </Text>
                    </View>
                  </View>
                </View>
