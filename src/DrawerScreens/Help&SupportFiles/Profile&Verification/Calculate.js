            ...
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  If you created a team for a certain match, it counts as a
                  Match Played in your Career Stats. Similarly, if you have
                  joined one contest with 3 different teams, then it counts as 3
                  Contests Played in your career stats.
                </Text>
              </View>
