        ...
        <View
          ...
          <View
            ...
            <View style={{flexDirection: 'row', gap: 5}}>
              <Text
                style={{fontWeight: 'bold', fontSize: hp(2.8), color: '#000'}}>
            ...
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  As per the Google Play store policy to ensure compliance with
                  state Gaming law,  you need to verify any one the Aadhar card,
                  Voter ID, or Diving license.
                </Text>
              </View>
