              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Go to 'My Info & Settings' from the side Navigation menu and
                    click on the pencil icon on the mobile number field, enter
                    the new mobile number, enter the new OTP you receive, and
                    that's it!
                  </Text>
                  <Text style={{color: '#000'}}>
                    Your new number is verified, and we'll send you a
                    confirmation on your verified email ID.
                  </Text>
                  <Text style={{color: '#000'}}>
                    A few things to remember while changing the mobile number:
                  </Text>
                  <View style={{flexDirection: 'column', width: wp('78%')}}>
                    <View style={{flexDirection: 'row'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        Your new mobile number is not linked to any other
                        Impact11 account
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <Entypo name="dot-single" size={24} color="black" />
                      <Text style={{color: '#000'}}>
                        You can change your mobile number thrice from the app
                      </Text>
                    </View>
                  </View>
                </View>
