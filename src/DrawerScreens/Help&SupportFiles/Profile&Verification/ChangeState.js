              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Go to 'My Info & Settings' from the side navigation menu.
                  </Text>
                  <Text style={{color: '#000'}}>
                    However, in case you have verified your KYC documents (i.e.
                    Aadhaar/ Driving Licence/ Voter ID) on your Impact11
                    account, the State will be auto-picked based on this
                    document and cannot be changed via the app.
                  </Text>
                </View>
