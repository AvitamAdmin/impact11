              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    The mail sent by Impact11 might have been marked as “Spam”
                    and could have been sent to the spam folder of your mailbox.
                    In such a case, please check the spam folder of your mailbox
                    and mark Impact11 as ‘Not Spam,’ additionally add Impact11
                    to your save sender list to avoid any future inconvenience.
                  </Text>
                </View>
