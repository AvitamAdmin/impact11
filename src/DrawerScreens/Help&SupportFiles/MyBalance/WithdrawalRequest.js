              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  <Text
                    ...
                    I’ve placed a withdrawal request, when will I receive my
                    money?
                  </Text>
                  <Text style={{color: '#000'}}>
                    A successful withdrawal request will be deposited to your
                    bank accounts within{' '}
                    <Text style={{fontWeight: 'bold'}}>2-3 business days</Text>.
                  </Text>
                  <Text style={{color: '#000'}}>
                    PS: If your withdrawal request is processed but not credited
                    to your verified bank account within the mentioned
                    timeframe, please share a PDF copy of your bank statement
                    from the date of withdrawal with us. We’ll investigate this
                    for you.
                  </Text>
                </View>
