              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  <Text
                    ...
                    How do I manage PhonePe/Paytm wallets on Impact11?
                  </Text>
                  <Text style={{color: '#000'}}>
                    To link your wallets, go to the{' '}
                    <Text style={{fontWeight: 'bold'}}>
                      Side Navigation Menu {'>'} My Balance {'>'} Add {'>'}{' '}
                      Wallets,
                    </Text>{' '}
                    and tap 'Link Account' to connect your Paytm/PhonePe
                    wallets. Follow the on-screen instructions, authenticate
                    using OTP, and you're done.
                  </Text>
                  <Text style={{color: '#000'}}>
                    Note: Your Paytm/PhonePe wallet must be linked to the same
                    mobile number you use on Impact11.
                  </Text>
                </View>
