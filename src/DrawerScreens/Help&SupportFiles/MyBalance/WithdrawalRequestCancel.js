              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    A withdrawal request is usually cancelled if:
                  </Text>
                  <View style={{flexDirection: 'column', paddingLeft: 10}}>
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <Text style={{color: '#000'}}>1. </Text>
                      <Text style={{color: '#000'}}>
                        There’s an issue with your verified bank account
                      </Text>
                    </View>
                    <View style={{flexDirection: 'row', alignItems: 'center'}}>
                      <Text style={{color: '#000'}}>2. </Text>
                      <Text style={{color: '#000'}}>
                        Due to a FairPlay Violation.
                      </Text>
                    </View>
                  </View>
                  <Text style={{color: '#000'}}>
                    The cancellation reason will be mentioned alongside the
                    canceled transaction.
                  </Text>
                  <Text style={{color: '#000'}}>
                    If the cancellation reason is 'FairPlay Violation Detected',
                    please follow the FairPlay rules to avoid such cancellations
                    in the future.If the cancellation reason is 'FairPlay
                    Violation Detected', please follow the FairPlay rules to
                    avoid such cancellations in the future. 
                  </Text>
                </View>
