              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Tap the Side Navigation {'>'} Withdraw {'>'} Enter the
                  ...
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color: '#000'}}>
                      Your winning balance is Rs. 60 or more.
                    </Text>
                  </View>
                  ...
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color: '#000'}}>
                      You can make up to 3 withdrawal requests per day.
                    </Text>
                  </View>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color: '#000'}}>
                      The TDS (if applicable) and the post-tax amount that will
                      be credited to your bank account will be detailed for you.
                    </Text>
                  </View>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color: '#000'}}>
                      Each request must be at least Rs. 60 and can be up to
                      Rs.1,00,000
                    </Text>
                  </View>
                  <View style={{flexDirection: 'row', alignItems: 'center'}}>
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color: '#000'}}>
                      It may take up to 3 working days for your withdrawal to be
                      credited to your verified bank account.
                    </Text>
                  </View>
                </View>
