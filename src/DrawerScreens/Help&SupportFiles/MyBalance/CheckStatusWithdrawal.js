                ...
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    ...
                    <Text style={{fontWeight: 'bold', color: '#000'}}>
                      Side Navigation {'>'} My Balance {'>'} My Transaction.
                    </Text>
                  </Text>
                  <Text style={{color: '#000'}}>
                    In My Transaction go to the Withdrawal tab
                  </Text>
                  <Text style={{color: '#000'}}>
                    You can check the status of all these withdrawal
                    transactions for the last 6 months. 
                  </Text>
                  <Text style={{color: '#000'}}>
                    Details beyond the last 6 months can be downloaded via the
                    'Download' icon on the page.
                  </Text>
                </View>
