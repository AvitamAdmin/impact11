            ...
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  Final ranks and Points are updated immediately after the end
                  of every match. If a user wins a cash prize in a contest(s),
                  the winning amount will be credited automatically to the
                  Impact11 wallet of the user
                </Text>
              </View>
