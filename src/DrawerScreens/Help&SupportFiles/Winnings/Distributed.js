              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    In an event wherein there’s a tie between two or more users,
                    the winnings are distributed between the users equally.
                  </Text>
                  <Text style={{color: '#000'}}>For example,</Text>
                  <Text style={{color: '#000'}}>
                    If the winning amount for Rank 1 is Rs.1000 and Rank 2 is
                    Rs.500 and if two players have a tie at Rank1, total
                    winnings of both 1sr and 2nd Rank will be split equally
                    between two players.
                  </Text>
                  <Text style={{color: '#000'}}>
                                i.e. (1000+500)/2 = Rs.750, both players will
                    win Rs.750 each.
                  </Text>
                </View>
