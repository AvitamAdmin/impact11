              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Usually within 4 hours after the match is completed and
                    winners are declared!
                  </Text>
                  <Text style={{color: '#000'}}>
                    For matches ending late at night, your winnings will be
                    added to your Impact11 account the next morning after the
                    match winners are declared..
                  </Text>
                </View>
