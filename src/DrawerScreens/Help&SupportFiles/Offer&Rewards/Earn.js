            ...
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  When you invite friends on Impact11, you will earn cash bonus
                  for each friend as they keep playing on
                </Text>
                <Text style={{color: '#000'}}>
                  Your friend will get Rs.100 as Instant bonus and your will get
                  Rs.5 upto Rs.100 when your friend plays a cash contest.
                </Text>
              </View>
