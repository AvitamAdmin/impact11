              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Go to Refer & Earn Page and share your Invite link to your
                    friends via Whatsapp, Instagram, messages or any other app
                  </Text>
                  <Text style={{color: '#000'}}>
                    Your friend will get Rs.100 as Instant bonus and your will
                    get Rs.5 upto Rs.100 when your friend plays a cash contest.
                  </Text>
                </View>
