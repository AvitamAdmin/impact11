              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    In the 'My Matches' tab on the app home screen.
                  </Text>
                  ...
                  <View
                    ...
                    <Text style={{color: '#000'}}>
                      Before the match deadline, under the 'Upcoming' tab.
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color: '#000'}}>
                      After the match deadline, under the 'Live' tab.
                    </Text>
                  </View>
                  <View
                    style={{
                    ...
                    <Entypo name="dot-single" size={24} color="black" />
                    <Text style={{color: '#000'}}>
                      Once the match is completed, under the 'Completed' tab.
                    </Text>
                  </View>
                  <Text style={{color: '#000'}}>
                    PS: You'll see only the contests you've joined or the
                    contests that are not abandoned.
                  </Text>
                </View>
