              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Public contests are open for all to join. 
                  </Text>
                  <Text style={{color: '#000'}}>
                    Private contests are created by the users. These private
                    contests are only accessible to the users who have the
                    unique code for the contest. You can create a private
                    contest with a pre-defined number of participants and a
                    predefined winning amount and Invite your friends with
                    unique code.
                  </Text>
                </View>
