              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    You can edit your team before the match starts.
                  </Text>
                  <Text style={{color: '#000'}}>
                    Follow these steps to edit your team:
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 1: Go to the Home screen and click on the match for
                    which you wish to edit your team
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 2: Click on "My Teams" at the bottom-Right corner
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 3: Select the team that you wish to edit
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 4: Click on the pencil edit icon
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 5: Edit your team and click on "Continue"
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 6: Review the changes you have made and then click on
                    "Save Team". Your changes will be saved
                  </Text>
                </View>
