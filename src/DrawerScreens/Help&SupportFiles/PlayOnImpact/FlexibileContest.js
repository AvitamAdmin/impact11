              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Flexible contests are paid contests that don't get cancelled
                    even if only two teams join. Yes, that's correct.  If there
                    are two users in the flexible contest, the respective
                    contest will be converted into head-to-head.
                  </Text>
                  <Text style={{color: '#000'}}>
                    There will be no cancellation even if all spots don't fill
                    up.
                  </Text>
                  <Text style={{color: '#000'}}>
                  ...
                  <Text style={{color: '#000'}}>
                    The Prize Pool for the contest will be increase or decrease
                    based on the teams joining.
                  </Text>
                  <Text style={{color: '#000'}}>
                    The Prize Pool for the contest will be increase or decrease
                    based on the teams joining.
