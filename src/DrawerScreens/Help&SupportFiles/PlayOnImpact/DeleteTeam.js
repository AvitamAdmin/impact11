...
const DeleteTeam = () => {
  ...
  return (
    <SafeAreaView>
      <View style={{height: hp('1]00%'), width: wp('100%')}}>
        <View
            ...
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  You cannot delete your team once created, else you can edit
                  your team or create a new team and switch it earlier one.
                </Text>
              </View>
