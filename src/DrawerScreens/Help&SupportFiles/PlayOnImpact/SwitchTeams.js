              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Step 1: Head to 'My Matches' and select the match you wish
                    to switch teams for, from the 'Upcoming' section
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 2: Tap 'My Contests' and select the contest you wish to
                    switch teams for
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 3: Tap on 'Leaderboard' and click on the 'Two Arrows'
                    to the right{' '}
                  </Text>
                  <Text style={{color: '#000'}}>
                    Step 4: Uncheck the selected team, check the team you want
                    to switch with, tap on 'Switch Teams', and that's it!
                  </Text>
                  <Text style={{color: '#000'}}>
                    PS: You can switch teams only when you have created more
                    than one team for the contest.
                  </Text>
                </View>
