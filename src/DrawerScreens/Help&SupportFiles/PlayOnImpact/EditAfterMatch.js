              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    You can edit your team any time before the match starts,
                    even after the line-ups are announced. Please make sure to
                    save your edited team. You cannot make any changes to your
                    team once the match starts.
                  </Text>
                </View>
