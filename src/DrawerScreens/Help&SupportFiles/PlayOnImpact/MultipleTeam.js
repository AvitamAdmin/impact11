              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  <Text
                    ...
                    Can I join a Impact11 contest with multiple teams?
                  </Text>
                  <Text style={{color: '#000'}}>
                    The number of teams allowed per user depends on the type of
                    contest.
                  </Text>
                  <Text style={{color: '#000'}}>
                    Except "Head-to-Head" and "Winner Takes All" contests, you
                    can join every other contest with multiple teams.
                  </Text>
                  <Text style={{color: '#000'}}>
                    For example, you can join a Grand League with up to 20
                    teams. You will see the number of teams allowed per user
                    shown next to “M” below "Total spots " on every contest card
                    mentioned as “Upto 20” or “Upto 11”.
                  </Text>
                  <Text style={{color: '#000'}}>
                    For example, you can join a Grand League with up to 20
                    teams. You will see the number of teams allowed per user
                  ...
                  <Text style={{color: '#000'}}>
                    You can join each "Head-to-Head" and "Winner Takes All"
                    contest with only one team.
                  </Text>
                </View>
