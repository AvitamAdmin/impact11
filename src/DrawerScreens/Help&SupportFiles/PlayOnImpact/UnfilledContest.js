              ...
              <View style={{flexDirection: 'column', gap: 40}}>
                <View style={{flexDirection: 'column', gap: 15}}>
                  ...
                  <Text style={{color: '#000'}}>
                    Public contest(s) won’t get cancelled when:
                  </Text>
                  <View style={{flexDirection: 'column'}}>
                    <Text style={{color: '#000'}}>
                      2.Contest Card has Flexible tag in it{' '}
                    </Text>
                    <Text style={{color: '#000'}}>
                      (In the case of Flexible public contests, the prize pool
                      gets adjusted based on the number of spots that are
                      filled)
                    </Text>
                  </View>
                  <Text style={{color: '#000'}}>
                    3. 90% of total spots are filled in 6+ member contests.
                  </Text>
                </View>
