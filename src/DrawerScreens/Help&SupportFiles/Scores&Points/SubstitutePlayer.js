            ...
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  No, your team is not awarded any points for a substitute
                  player in case he replaces any player on-field as the
                  substitute is not considered as a part of playing XI in
                  cricket & football
                </Text>
              </View>
