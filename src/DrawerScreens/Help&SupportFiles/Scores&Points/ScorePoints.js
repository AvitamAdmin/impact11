            ...
            <View style={{flexDirection: 'column', gap: 40}}>
              <View style={{flexDirection: 'column', gap: 15}}>
                ...
                <Text style={{color: '#000'}}>
                  Your players will get points based on their performance on the
                  field. They get Points for every run, Wickets, catch etc.,
                  Head to “Fantasy Point System” to know more about the points
                </Text>
              </View>
