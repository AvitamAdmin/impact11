...
const Live_Completed_TeamPreview = ({visible, onClose, route}) => {
    ...
    const fetchPlayerData = async (playersId) => {
...
export default React.memo(Live_Completed_TeamPreview);
