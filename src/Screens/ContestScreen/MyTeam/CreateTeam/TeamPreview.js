...
const TeamPreview = ({ visible, onClose }) => {
  ...
  const player = useSelector(state => state.fantasy.finalPlayerSelected);
            ...
            {player.length > 0 ? (
              ...
              <View
                style={{
                  ...
                  <View
                  style={{flexDirection:"column",width:"100%",display:"flex",justifyContent:"center",alignItems:"center",gap:10}}
                  >
                    <View>
                      <Text style={{color:"#fff",fontSize:12,fontWeight:"700"}}>No players selected yet</Text>
                    </View>
                    <Pressable style={{backgroundColor:"#fff",borderRadius:5,padding:4,alignItems:"center"}}>
                      <Text style={{color:"#000",fontSize:12,fontWeight:"700"}}>Start Selecting</Text>
                    </Pressable>
                  </View>
              </View>
            )}
