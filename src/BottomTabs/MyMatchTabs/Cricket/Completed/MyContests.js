        ...
        <ScrollView
          contentContainerStyle={{
            ...
            <Live_Completed_TeamPreview
                  ...
                  />
          {contestSummary && contestSummary.totalWinningAmount > 0 && (
            <View style={{width: '100%', padding: 5}}>
              <View
                ...
                <Pressable
                  ...
                  <ImageBackground
                    source={require('../../../../../assets/Won-BG.png')}
                    resizeMode="cover"
                        ...
                        <View
                          ...
                          <View
                            ...
                            <View
                              ...
                              <Text style={{color: '#000', fontSize: hp(1.5)}}>
                                You've won in{' '}
                                {contestSummary.contestJoinedCount}{' '}
                                {contestSummary.contestJoinedCount > 1
                                  ? 'Contests'
                                  : 'Contest'}
                              </Text>
                            </View>
