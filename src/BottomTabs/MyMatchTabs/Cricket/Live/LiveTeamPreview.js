...
const LiveTeamPreview = ({route}) => {
  ...
  const fetchPlayerData = async (token, playersId) => {
    ...
    const impact = playersId.find(
      player => player.impactPlayer === true,
    )?.playerId;
    setImpact(impact);

    const captain = playersId.find(player => player.captain === true)?.playerId;

    setCaptain(captain);
    console.log('Captain:', captain);

    const viceCaptain = playersId.find(
              ...
              <View
                ...
                <View
                  ...
                  <Text
                    ...
                    {' '}
                    {teamPoints ? `${teamPoints} Points` : '0  Points'}
                  </Text>
                </View>
              </View>
              <View
                ...
                <View style={{flexDirection: 'row', gap: 10, width: '50%'}}>
                  <View
                    ...
                    <Text
                      style={{color: '#000', fontSize: 12, fontWeight: '700'}}>
                      {team1Name}
                    </Text>
                  </View>
                  <View>
                  ...
                  <View
                    ...
                    <View
                      ...
                      {WicketKeepers.slice(
                        ...
                        const playerPoints = players.find(
                          play => play.playerId === player.recordId,
                        );
                        return (
                          <View
                            key={index}
                    ...
                    {WicketKeepers.length >
                      ...
                      <View
                        ...
                        {WicketKeepers.slice(
                          ...
                          // Add player points lookup for second row players
                          const playerPoints = players.find(
                            play => play.playerId === player.recordId,
                          );
                          return (
                            <View
                              ...
                              {/* Add points display for second row players */}
                              <View>
                                <Text
                                  style={{
                                    color: '#fff',
...
export default LiveTeamPreview;
